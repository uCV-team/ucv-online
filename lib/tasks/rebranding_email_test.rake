namespace :rebranding_test do
  ...
  task email_users: :environment do
    test_emails = ['vishal+1@bluebash.co', 'anuj@bluebash.co', 'rahul+1@bluebash.co', 'ritik.sharma@bluebash.co',
                   'nikita.bhatia@bluebash.co', 'villanivalerio33@gmail.com', 'vishal@bluebash.co',
                   'duccioarmenise@gmail.com', 'varun-kumar211']
